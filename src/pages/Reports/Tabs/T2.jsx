        ...
        <Grid borderWidth='1px' maxW="full" borderRadius="lg" p={5}>
            <Grid templateColumns='repeat(4, 1fr)' gap={5}>
                ...
                <SimpleGrid columns={2} gap={3}>
                        <GridItem colSpan={1}>
                            <Text fontSize="lg" align="center" pb={5}>Women pregnant for the 1st time given at least two (2) doses of Td Vaccine</Text>
                        ...
                        <GridItem colSpan={1}>
                            <Text fontSize="lg" align="center" pb={5}>Women pregnant for the 2nd or more times given at least three (3) doses of Td</Text>
                            <SimpleGrid columns={4} gap={3}>
                                <GridItem colSpan={3}>
                                    <Grid templateColumns='repeat(3, 1fr)' gap={3}>
                                        <GridItem borderColor='black' p={5} colSpan={3} rowSpan={1} border='1px' borderRadius="lg">
