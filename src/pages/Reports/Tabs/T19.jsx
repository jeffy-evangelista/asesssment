        ...
        <Grid borderWidth='1px' maxW="full" borderRadius="lg" p={5}>
            <Grid templateColumns='repeat(4, 1fr)' gap={5}>
                ...
                <SimpleGrid columns={2} gap={3}>
                        <GridItem colSpan={1}>
                            <Text fontSize="lg" align="center" pb={5}>Full term (37-42 weeks AOG)</Text>
                        ...
                        <GridItem colSpan={1}>
                            <Text fontSize="lg" align="center" pb={5}>Pre-term (22-36 weeks AOG)</Text>
                            <SimpleGrid columns={4} gap={3}>
                                <GridItem colSpan={3}>
                                    <Grid templateColumns='repeat(3, 1fr)' gap={3}>
                                        <GridItem borderColor='black' p={5} colSpan={3} rowSpan={1} border='1px' borderRadius="lg">
                        ...
                        <GridItem colSpan={1}>
                            <Text fontSize="lg" align="center" pb={5}>Fetal Death</Text>
                            <SimpleGrid columns={4} gap={3}>
                                <GridItem colSpan={3}>
                                    <Grid templateColumns='repeat(3, 1fr)' gap={3}>
                                        <GridItem borderColor='black' p={5} colSpan={3} rowSpan={1} border='1px' borderRadius="lg">
                        ...
                        <GridItem colSpan={1}>
                            <Text fontSize="lg" align="center" pb={5}>Abortion (Counts Only)</Text>
                            <SimpleGrid columns={4} gap={3}>
                                <GridItem colSpan={3}>
                                    <Grid templateColumns='repeat(3, 1fr)' gap={3}>
                                        <GridItem borderColor='black' p={5} colSpan={3} rowSpan={1} border='1px' borderRadius="lg">
